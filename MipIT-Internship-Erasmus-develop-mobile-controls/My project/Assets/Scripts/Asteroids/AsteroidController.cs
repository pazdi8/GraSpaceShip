...
public class AsteroidController : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        player = GameObject.Find("playerCharacterPrefab").GetComponent<CharacterController>();
       // explosion = GameObject.Find("MapLimitations").GetComponent
    }

    void Update()
    {
        // player.currentHealth - zdrowie
